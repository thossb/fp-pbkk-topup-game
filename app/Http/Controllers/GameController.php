...
class GameController extends Controller
{
    ...
    public function map()
    {
        $games = $this->gameService->getPaginatedGames(6);
    ...
    public function show($id)
    {
        ...
        return view('games.show', compact('game', 'denoms'));
    }

    public function addGame(Request $request)
    {
        $this->gameService->addGame($request);
    ...
    public function updateGame(Request $request, $id)
    {
        $this->gameService->updateGame($request, $id);
