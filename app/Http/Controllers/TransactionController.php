...
class TransactionController extends Controller
{
    ...
    public function getMyTransactions(Request $request)
    {
        return $this->transactionService->getMyTransactions($request);
    }
    ...
    public function getTransactionsData()
    {
        return $this->transactionService->getTransactionsData();
    }
    ...
    public function rejectTransaction(Request $request, $id)
    {
        return $this->transactionService->rejectTransaction($request, $id);
    }
}